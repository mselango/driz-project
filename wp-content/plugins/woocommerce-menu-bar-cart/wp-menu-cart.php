...
class WpMenuCart {	 
	...
	*/
	...
	public function add_itemcart_to_menu( $items ) {
		$classes = 'wpmenucartli cart wpmenucart-display-'.$this->options['items_alignment'];
	...
	public function wpmenucart_menu_item() {
		...
		switch ($this->options['items_display']) {
			case 1: //items only
				$menu_item_a_content .= '<span class="cartcontents cart-alert">'.$cart_contents.'</span>';
				break;
			case 2: //price only
		...
		$menu_item .= "<a class='mobile-cart' href='".$menu_item_href."'><span class='cartcontents'>".$cart_contents." Items in your cart</span></a>";
